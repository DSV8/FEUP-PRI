...
RESULTS_FILE="retrieval_config/results/results_sys2_trec.txt"
TREC_EVAL_RESULTS="retrieval_config/results/trec_eval_results_sys2.txt"
...
if ! cat "$RESULTS_FILE" | ./scripts/retrieval_eval/plot_pr.py --qrels "$QRELS_TREC_FILE" --output "$IMAGES_DIR/prec_rec_sys2.png"; then
